...
DESeq2Clusterplot = function(filepath='/Users/gregbrittingham/Dropbox (Personal)/Scripts/Nacho_RNAseq_2020_final/Ignacio_RNAseq_drop_snf5_del/text_files/WT_Starve_v_Dex.txt', filename='WT_Starve_v_Dex', numbergenes = 25){
    library("pheatmap")
    library("DESeq2")
   ...
   pheatmap(cluster, cluster_rows=TRUE, show_rownames=F,
            cluster_cols=TRUE, show_colnames = T, annotation_col = df, scale_rows = T, color = colorRampPalette(c("navy","white","red"))(50))
